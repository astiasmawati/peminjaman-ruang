...
<div class="modal fade" id="modalBooking">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Booking perangkat</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_perangkat" class="form-control">
                                    <?php
                                    $ruangan2 = $this->m_siplabs->get_data('ruangan')->result();
                                    foreach ($ruangan2 as $r2) : ?>
                                        <option value="<?php echo $r2->id_perangkat ?>"><?php echo $r2->perangkat ?> - <?php echo $r2->merk ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
